...
#import smbus  # habilitar para Raspberry
import math, time, os
...
try:
	f = open('sensorGiroscopioAcelerometro.i2c', 'w')
	while 1:
		...
		f.write('x_rotation: ' + str(get_x_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled)) +'\n')
		f.write('y_rotation: ' + str(get_y_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled)) +'\n')
